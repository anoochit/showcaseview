...
public class SampleActivity extends Activity implements View.OnClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		StrictMode.setThreadPolicy(new StrictMode.ThreadPolicy.Builder().detectCustomSlowCalls().detectDiskWrites().penaltyDialog().build());
		...
		sv = ShowcaseView.insertShowcaseView(R.id.button1, this, "ShowcaseView Sample", "When the ShowcaseView is showing, " +
